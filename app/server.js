...
[
  ...
  ["/content-server-frontend.js","application/javascript"],
  ["/frontend.html","text/html"],
  ["/content-server-frontend.html", "text/html"]
].forEach(function(fn){
  http_files[fn[0]]={
...
http_files["/content-server-frontend"]=http_files["/content-server-frontend.html"];
...
server.listen(webSocketsServerPort, function() {
  ...
  console.log(" browse for messages: http://localhost:" + webSocketsServerPort);
  console.log(" browse for sending message: http://localhost:" + webSocketsServerPort + "/content-server-frontend")
});
